...
export const CATALOG = [
  ...
  { route: "GET /v1/proxy/1gb", price: "$3.50", desc: "Buy 1 GB of residential proxy bandwidth and receive a ready-to-use proxy key in the form http://buyer:KEY@host, valid for 30 days and metered per gigabyte. Your HTTP and HTTPS traffic exits through a real residential IP address, which reaches sites that block datacenter ranges outright. Built for agents, crawlers and scrapers that need a trustworthy exit point rather than a cloud IP.",
